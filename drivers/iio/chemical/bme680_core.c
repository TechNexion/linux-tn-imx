 ...
 *
 * Datasheet:
 * https://ae-bst.resource.bosch.com/media/_tech/media/datas...
 */
 ...
 * https://github.com/BoschSensortec/BME680_driver/blob/63bb...
 *
				 ...
				 u8 gas_range)
{
	...
	var4 = (var3 +((s64) var2 >> 1));
	calc_gas_res = do_div(var4,((s64) var2));
