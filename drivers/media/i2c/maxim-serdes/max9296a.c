...
static int max9296a_set_enable(struct max_des *des, bool enable)
{
	...
	return regmap_update_bits(priv->regmap, MAX9296A_BACKTOP12,
				 ...
				 struct max_des_phy_mode *mode)
{
	...
	ret = regmap_update_bits(priv->regmap, MAX9296A_MIPI_TX51(phy_id),
	...
	return regmap_update_bits(priv->regmap, MAX9296A_MIPI_TX51(phy_id),
				     ...
				     enum max_serdes_gmsl_version version)
{
	...
	ret = regmap_update_bits(priv->regmap, MAX9296A_MIPI_TX0(index),
	...
	ret = regmap_update_bits(priv->regmap, MAX9296A_REG6,
	...
	return regmap_update_bits(priv->regmap, MAX9296A_REG4,
