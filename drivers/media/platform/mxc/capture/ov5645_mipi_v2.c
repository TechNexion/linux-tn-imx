...
static struct reg_value ov5645_setting_60fps_720P_1280_720[] = {
	{0x3103, 0x11, 0, 0},
	//	Comment this out in order for AF to work
	//	{0x3008, 0x82, 0, 0},
	{0x3008, 0x42, 0, 0},	{0x3103, 0x03, 0, 0},	{0x3503, 0x07, 0, 0},
...
static struct ov5645_mode_info ov5645_mode_info_data[3][ov5645_mode_MAX + 1] = {
	{
	...
	},
	{
		...
		{ov5645_mode_NTSC_720_480, -1, 0, 0, NULL, 0},
		{ov5645_mode_720P_1280_720, SUBSAMPLING, 1280, 720,
		ov5645_setting_60fps_720P_1280_720,
		ARRAY_SIZE(ov5645_setting_60fps_720P_1280_720)},
			       ...
			       struct v4l2_subdev_frame_size_enum *fse)
{
	...
	fse->max_width =
		max(max(ov5645_mode_info_data[0][fse->index].width,
				ov5645_mode_info_data[1][fse->index].width),
					ov5645_mode_info_data[2][fse->index].width);

	fse->min_width = fse->max_width;
	fse->max_height =
		max(max(ov5645_mode_info_data[0][fse->index].height,
				ov5645_mode_info_data[1][fse->index].height),
					ov5645_mode_info_data[2][fse->index].height);
...
static int init_device(struct ov5645 *sensor)
{
	...
	if (tgt_fps == 15)
		...
		return -EINVAL; /* Only support 15fps ,30fps or 60fps now. */
